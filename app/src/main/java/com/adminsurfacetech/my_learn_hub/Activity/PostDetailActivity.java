...
import com.adminsurfacetech.my_learn_hub.Adapter.CommentAdapter;
import com.adminsurfacetech.my_learn_hub.Models.Comment;
...
public class PostDetailActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // set the statues to be transparent
       // Window w = getWindow();
     //   w.setFlags(WindowManager.LayoutParams.FLAG_LAYOUT_NO_LIMITS,WindowManager.LayoutParams.FLAG_LAYOUT_NO_LIMITS);
       // getSupportActionBar();
        ...
        // now bind all data to views
        // then call out all data in post view package
        ...
        // comment user image center
        Glide.with(this).load(firebaseUser.getPhotoUrl()).into(imgCurrentUser);
        // get the post time and id here
